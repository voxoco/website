    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8 xl:col-span-1">
          <img class="h-10" src="/public/assets/images/logo-footer.png" alt="VOXO" />
        </div>
      ...
      <div class="mt-12 border-t border-voxo-gray-hr pt-8 flex">
        <div class="flex-1 text-voxo-gray-footer-text">
